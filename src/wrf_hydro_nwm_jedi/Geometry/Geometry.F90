...
subroutine wrf_hydro_nwm_jedi_geometry_init(self, f_conf)
  ...
  !call abor1_ftn("ERROR: wrf_hydro_nwm_jedi_geometry_init() needs to be implemented.")

  wrfinput_flnm = '/home/alex/Downloads/JEDI/src/build/wrf_hydro_nwm_jedi/test/testinput/wrfinput.nc'
...
subroutine wrf_hydro_nwm_jedi_geometry_clone(self, other)
  ...
  !call abor1_ftn("ERROR: wrf_hydro_nwm_jedi_geometry_clone() needs to be implemented.")
end subroutine
...
subroutine wrf_hydro_nwm_jedi_geometry_delete(self)
  ...
  !call abor1_ftn("ERROR: wrf_hydro_nwm_jedi_geometry_delete() needs to be implemented.")
end subroutine
...
subroutine wrf_hydro_nwm_jedi_geometry_get_info(self,dx_,dy_)
