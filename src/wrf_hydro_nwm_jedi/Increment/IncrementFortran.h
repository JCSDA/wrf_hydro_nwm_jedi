...
namespace wrf_hydro_nwm_jedi {
  ...
  extern "C" {
    ...
    void wrf_hydro_nwm_jedi_increment_to_fieldset_f90(const F90inc &, const F90geom &, const oops::Variables &,
                                         atlas::field::FieldSetImpl *);
    void wrf_hydro_nwm_jedi_increment_to_fieldset_ad_f90(const F90inc &, const F90geom &,
                                            const oops::Variables &,
                                            const atlas::field::FieldSetImpl *);
    void wrf_hydro_nwm_jedi_increment_from_fieldset_f90(const F90inc &, const F90geom &, const oops::Variables &,
                                           const atlas::field::FieldSetImpl *);
