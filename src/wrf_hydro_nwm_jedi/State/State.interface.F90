...
subroutine wrf_hydro_nwm_jedi_state_create_c(c_key_self, c_key_geom, c_vars) bind(c,name='wrf_hydro_nwm_jedi_state_create_f90')
...
subroutine wrf_hydro_nwm_jedi_state_delete_c(c_key_self) bind(c,name='wrf_hydro_nwm_jedi_state_delete_f90')
...
subroutine wrf_hydro_nwm_jedi_state_zero_c(c_key_self) bind(c,name='wrf_hydro_nwm_jedi_state_zero_f90')
...
subroutine wrf_hydro_nwm_jedi_state_copy_c(c_key_self,c_key_rhs) bind(c,name='wrf_hydro_nwm_jedi_state_copy_f90')
...
subroutine wrf_hydro_nwm_jedi_state_axpy_c(c_key_self,c_zz,c_key_rhs) bind(c,name='wrf_hydro_nwm_jedi_state_axpy_f90')
...
subroutine wrf_hydro_nwm_jedi_state_read_file_c(c_key_geom, c_key_state, c_conf, c_dt) bind(c,name='wrf_hydro_nwm_jedi_state_read_file_f90')
...
subroutine wrf_hydro_nwm_jedi_state_analytic_init_c(c_key_state, c_key_geom, c_conf, c_dt) bind(c,name='wrf_hydro_nwm_jedi_state_analytic_init_f90')
...
subroutine wrf_hydro_nwm_jedi_state_write_file_c(c_key_geom, c_key_state, c_conf, c_dt) bind(c,name='wrf_hydro_nwm_jedi_state_write_file_f90')
...
subroutine wrf_hydro_nwm_jedi_state_gpnorm_c(c_key_state, kf, pstat) bind(c,name='wrf_hydro_nwm_jedi_state_gpnorm_f90')
...
subroutine wrf_hydro_nwm_jedi_state_sizes_c(c_key_self,nx,ny,nf) bind(c,name='wrf_hydro_nwm_jedi_state_sizes_f90')
