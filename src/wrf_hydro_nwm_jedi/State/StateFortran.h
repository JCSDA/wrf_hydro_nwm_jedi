...
namespace wrf_hydro_nwm_jedi {
  ...
  extern "C" {
    ...
    void wrf_hydro_nwm_jedi_state_read_file_f90(const F90geom &, const F90state &, const eckit::Configuration * const *, const util::DateTime * const *);
    void wrf_hydro_nwm_jedi_state_write_file_f90(const F90geom &, const F90state &, const eckit::Configuration * const *, const util::DateTime * const *);
    ...
    // void wrf_hydro_nwm_jedi_state_rms_f90(const F90state &, const double &);
