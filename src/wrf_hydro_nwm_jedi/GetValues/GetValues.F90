...
use wrf_hydro_nwm_jedi_field_mod,   only: wrf_hydro_nwm_jedi_fields,coords,base_field
...
type, abstract :: wrf_hydro_nwm_jedi_getvalues_base
...
type, extends(wrf_hydro_nwm_jedi_getvalues_base) :: wrf_hydro_nwm_jedi_getvalues
...
!   ! -------------
   ...
   do i = 1, locs%nlocs
      ...
      coo%dim_1 = idx_1
      coo%dim_2 = idx_2
      geovals_tmp(i) = field%get_value(coo)!field%array(idx_1, idx_2, 1)
   end do
